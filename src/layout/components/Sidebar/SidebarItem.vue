      ...
      <template>
        <el-submenu v-if="item.children && item.children.length" ref="subMenu" :index="resolvePath(item.path)">
          ...
          <template v-for="itemChild in item.children">
            <!-- 有子集-->
            <el-submenu v-if="itemChild.children && itemChild.children.length" :index="itemChild.path" :key="itemChild.path" :base-path="resolvePath(itemChild.path)">
              <template slot="title">
              ...
              <sidebar-item
                ...
                :base-path="resolvePath(itemChild_Child.path)"
                class="nest-menu"
              />
            </el-submenu>
            <!--没有子集-->
