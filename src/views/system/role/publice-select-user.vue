  ...
  <my-dialog ref="userDialog" title="选择人员" >
    <div slot="dialogContent" class="dialog-content">
       ...
       <div class="top-form">
         <div>
           <span>角色名称：</span>
           <el-input :disabled="true"  v-model="roleName" style="width: 340px;"    />
         </div>
       </div>
...
<!--                   </el-tooltip>-->
    ...
    <div slot="footer" class="btn-foot">
      ...
      <el-button @click="closeDialog" style="margin-right: 10px">取 消</el-button>
    </div>
  </my-dialog>
</template>
...
export default {
  ...
  methods: {
    ...
    closeDialog() {
      ...
      this.$set(this.$refs.transfer.$refs.leftPanel,'query','')
      this.userTotal = 0
