  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
     ...
     <!-- <el-form-item label="创建时间">
      ...
      <el-form-item class="searchOperat">
       ...
       <!-- <template slot-scope="scope">
        ...
        <template slot-scope="scope">
          <div style="width:100%;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">
            <el-button style="width:100%;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;"
                       type="text" @click="handleDetail(scope.row)" size="small" >{{scope.row.dictType}}</el-button>
          </div>
        </template>
      </el-table-column>
      <el-table-column label="状态" prop="status" :formatter="statusFormat" :show-overflow-tooltip="true"/>
