<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="参数主键" prop="configId" :show-overflow-tooltip="true" />
      ...
      <el-table-column label="系统内置" prop="configType" :formatter="typeFormat" :show-overflow-tooltip="true" />
