          ...
          <div class="page-header" style="height: 50px">
            ...
            <div class="header-left">
              <div style="padding-left:20px;display: flex;align-items: center">
                ...
                <span style="font-size: 20px">待办详情</span>
              </div>
            </div>
            <div class="header-right">

<!--              <el-button-->
<!--                v-if="todoDetailData.todoType != 3"-->
<!--                class="suspend"-->
<!--                size="mini"-->
<!--                @click="suspendApplyItems()"-->
<!--              >结束-->
<!--              </el-button>-->
              ...
              <el-button
                ...
                v-if="todoDetailData.todoType != 3"
                @click="handOverApplyItems()"
                class="handOver"
                size="mini"
              >移交
              </el-button>
              <el-button
                v-if="todoDetailData.whetherAllowReject && todoDetailData.todoType != 3"
