        ...
        <div class="page-header" style="height: 50px">
          <div class="header-left">
            <div style="padding-left:20px;display: flex;align-items: center">
              ...
              <span style="font-size: 20px">全部待办</span>
            </div>
          </div>
              ...
              <el-table
                ...
                <el-table-column
                  ...
                  <template  slot-scope="scope">
                    <span style="color: #47a1fb;font-size: 12px;cursor: pointer;"  @click="enterMyAgentDetail(scope.row)">{{ scope.row.havedoName }}</span>
                  </template>
                </el-table-column>
                <el-table-column
...
<script>
  import {getAllHavedo} from '../../../../src/api/processEngine/processEngine'
  export default {
    name: 'AllHaveToDo',
    data() {
      return {
    ...
    methods: {
      ...
      requestTodoList(){
        ...
        getAllHavedo(param).then(response => {
      ...
      enterMyAgentDetail(e){


        console.log(JSON.stringify(e)+"SDfsdfgdfhdfgsx");

        this.$router.push({
          path:'allHaveToDoDetail',
          query: {
            havedoId : e.havedoId
          }
        })
