              ...
              <el-table
                ...
                <el-table-column
                  ...
                  <template  slot-scope="scope">
                    <span style="color: #47a1fb;font-size: 12px;cursor: pointer;"  @click="enterMyAgentDetail(scope.row)">{{ scope.row.todoName }}</span>
                  </template>
                </el-table-column>
                <el-table-column
...
<script>
  import {getAllTodo} from '../../../../src/api/processEngine/processEngine'
  export default {
    name: 'AllAgent',
    data() {
      return {
    ...
    methods: {
      ...
      requestTodoList(){
        ...
        getAllTodo(param).then(response => {
