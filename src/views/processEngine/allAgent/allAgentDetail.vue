          ...
          <div class="page-header" style="height: 50px">
            ...
            <div class="header-left">
              <div style="padding-left:20px;display: flex;align-items: center">
                ...
                <span style="font-size: 20px">全部待办详情</span>
              </div>
            </div>
            <div class="header-right">

              <el-button
                @click="cuiBanTaskClick()"
                class="agree"
                size="mini"
              >催办
              </el-button>
              ...
              <el-button
                style="position: relative;width: 10px;height: 30px;top: 3px;border: 0px solid #DCDFE6;margin-left: -2px"
                width="20px"
                size="mini"
              >
                <div style="height: 20px;width: 1px;background-color: #E5E9F2;margin-top: -2px"></div>
              </el-button>
...
<script >
  ...
  import {getApprovalRecord,getNodeList,updateUrge} from '../../../../src/api/processEngine/processEngine'
  ...
  export default {
    ...
    methods: {
      ...
      cuiBanTaskClick(){
        ...
        param.todoId = this.todoId;
        // 催办任务
        updateUrge(param).then(response => {
          if (response.code == '200') {
            that.msgSuccess("催办成功");
