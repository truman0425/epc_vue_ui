          ...
          <div class="page-header" style="height: 50px">
            <div class="header-left">
              <div style="padding-left:20px;display: flex;align-items: center">
                ...
                <span style="font-size: 20px">我的申请详情</span>
              </div>
            </div>
...
<script >
  ...
  import {getTaskDetail,getWithdrawFlow} from '../../../../src/api/processEngine/processEngine'
  ...
  export default {
    ...
    created(){
      ...
      console.log(JSON.stringify(this.taskId)+"hkjjkhghsdhj")
      this.requsetTaskDetail()
    ...
    methods: {
      requsetTaskDetail() {
        ...
        getTaskDetail(param).then(response => {
      ...
      toWithdraw(){
        ...
        var that = this;
        this.$confirm('您确认要撤回本条消息吗？', '温馨提示', {
          confirmButtonText: '确定',
          cancelButtonText: '取消',
          type: 'warning'
        }).then(() => {
          var businessId = that.todoDetailData.businessId;
          var param = {}
          param.businessId = businessId
          getWithdrawFlow(param).then(response => {
